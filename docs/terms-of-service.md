...
- **Country** referes to: Alberta, Canada
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to HellCom StratDef Network's development team.
- **Service** refers to the Discord Bot.
...
- **Discord Bot** refers to the HellCom StratDef Network Discord Bot.
